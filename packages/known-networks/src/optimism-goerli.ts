...
export class OptimismGoerliNetwork implements INetwork {
  ...
  constructor () {
    this.info = 'optimism-goerli';
    this.text = 'Optimism Goerli Network';
  ...
  public serialize (): Uint8Array {
    ...
    return hexToU8a(OptimismGoerliNetworkHash);
  }
}

export const OptimismGoerliNetworkHash: HexString = u8aToHex(xxHash('optimism-goerli'));
