...
export class ArbitrumGoerliNetwork implements INetwork {
  ...
  constructor () {
    this.info = 'arbitrum-goerli';
    this.text = 'Arbitrum Goerli Network';
  ...
  public serialize (): Uint8Array {
    ...
    return hexToU8a(ArbitrumGoerliNetworkHash);
  }
}

export const ArbitrumGoerliNetworkHash: HexString = u8aToHex(xxHash('arbitrum-goerli'));
