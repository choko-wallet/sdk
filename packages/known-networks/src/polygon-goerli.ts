...
export class PolygonGoerliNetwork implements INetwork {
  ...
  public serialize (): Uint8Array {
    ...
    return hexToU8a(PolygonGoerliNetworkHash);
  }
}

export const PolygonGoerliNetworkHash: HexString = u8aToHex(xxHash('polygon-goerli'));
